...
map_colors <- colorBin("PRGn", c(0.5, 2), c(0.65, 0.8, .95, 1.05, 1.30, 1.8))
...
```{r}
sf_map_colors <- c('#7b3294','#c2a5cf','#f7f7f7','#a6dba0','#008837') 
