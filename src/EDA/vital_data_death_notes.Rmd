...
vital %>%
  ...
  geom_bar(stat='identity', position='dodge', fill = my_cols[5])+
  ...
  ggsave(here::here('output','Number_of_Deaths_by_ICD-10_Code.png'), height = 10, width = 20)
...
vital %>%
  ...
  theme(axis.text = element_text(size = 10, color = "gray30"))+
  ggsave(here::here('output','Death_by_race_prop.png'), height = 10, width = 20)
