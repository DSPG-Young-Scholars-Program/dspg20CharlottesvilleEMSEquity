...
## These are cases where we have one incident number, call sign, report type, and demo but still manage to have different outcome numbers
duplicates %>%
...
## Though even some of these seem reasonable (e.g. 2019-00013313)
...
## Problematic cases - there are duplicate demographics associated with multiple non-NA outcome report numbers
## In some cases, this is a result of there being multiple different report types, each with a different number for that patient
